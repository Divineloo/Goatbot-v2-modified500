...
config: {
    ...
    countDown: 5,
    role: 0,-cmd install bank.js const fs = require("fs");
...
🏦\n\n✧You have received ${amount}$\nFrom:\n✧Name: ${username}\n✧BankID: ${user}.\n✧ Your current Bank balance:\n${bankData[recipientUID].bank}$\n\n~DAVE Database✅`;
  await api.sendMessage(recipientMessage, recipientUID);
      ...
      case "richest":
        ...
        return message.reply("Richest people in the DAVE BANK system👑🤴:\n" + output);
